...
public class GapDownClose extends StrategyCommon{

	private Common common;
	
	public GapDownClose(OrderEntry orderEntry,Common common, List<SubmitedOrder> submitedOrdersList){
	...
	public void run(List<FBBar> list){
		...
		if(list.size() < 2) return;
		 ...
		 if(barB.getStartTime()-barA.getStartTime()>(60 * 60000)){
			 ...
			 double g2=-0.4;
			 double g1=-3.2;
			 if(gapPerc<g2 && gapPerc>g1  && barA.getEmaFast()/barA.getEmaSlow()>1.003 && barB.getVolume()>=15000){

				 
				 	Shares shares = new Shares(barA,barB,"GapDownClose");
				 
					mainL.info("Pre-Order {} ~ vol: {}, gap: {}, gap%: {},InvProfitRatio: {},RiskReward: {},slope: {},Inv:{},Strategy: GapDownClose ,isReasonable:{}, @: {}",
