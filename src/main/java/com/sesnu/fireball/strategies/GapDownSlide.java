...
public class GapDownSlide extends StrategyCommon{

	private Common common;
	
	public GapDownSlide(OrderEntry orderEntry,Common common, List<SubmitedOrder> submitedOrdersList){
		 ...
		 if(barB.getStartTime()-barA.getStartTime()>(60 * 60000)){
			...
			double g1=-2.1;
			 if(gapPerc<g2 && gapPerc>g1 
					 ...
					 && barA.getEmaSlow()/barA.getEmaFast()>1.0014 && barA.getEmaSlow()/barA.getEmaFast()<=1.0026
					 && barB.getVolume() > 15000
					 ){
				 
				 Shares shares = new Shares(barA,barB,"GapDownSlide");
				 
					mainL.info("Pre-Order {} ~ vol: {}, gap: {}, gap%: {},InvProfitRatio: {},RiskReward: {},slope: {},Inv:{},Strategy: GapDownSlide ,isReasonable:{}, @: {}",
